...
see the [api](https://github.com/bartue-dev/blog_api/blob/main/api-documentation.md) <a href="https://github.com/bartue-dev/blog_api/blob/main/api-documentation.md" target="blank" >api documentation</a> for more details of the usage of the api
